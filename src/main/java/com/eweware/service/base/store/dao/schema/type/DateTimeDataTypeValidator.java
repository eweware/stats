    ...
    public Object toValidValue(Object value, SchemaSpec spec) throws SystemErrorException {
        if (value instanceof String) { // expecting an ISO-formatted date string
            try {
                ...
                throw new SystemErrorException("invalid value for " + main.java.com.eweware.service.base.store.dao.schema.type.SchemaDataType.DT.getDescription(), e, ErrorCodes.SERVER_RECOVERABLE_ERROR);
            }
        }
        return value;
    }
